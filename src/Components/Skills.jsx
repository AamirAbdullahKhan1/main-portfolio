...
const skillCategories = [
  {
    ...
    skills: [
      { name: "Ollama", level: 90, description: "Local LLM deployment and fine-tuning" },
      { name: "LLM Fine-tuning", level: 85, description: "Custom model training and optimization" },
      { name: "Chatbot Development", level: 88, description: "Intelligent conversational AI systems" },
      { name: "TensorFlow", level: 75, description: "Deep learning model development" },
      { name: "PyTorch", level: 70, description: "Neural network implementation" },
      { name: "Hugging Face", level: 80, description: "Transformer models and NLP" },
    ],
  },
  {
    title: "Cybersecurity",
    ...
    skills: [
      { name: "Ethical Hacking", level: 70, description: "Penetration testing and vulnerability assessment" },
      { name: "Network Security", level: 75, description: "Firewall configuration and monitoring" },
      { name: "Cryptography", level: 65, description: "Encryption algorithms and implementation" },
      { name: "OWASP Top 10", level: 80, description: "Web application security best practices" },
      { name: "Security Auditing", level: 70, description: "Code review and security analysis" },
      { name: "Incident Response", level: 60, description: "Security breach handling and recovery" },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Python", level: 90, description: "Backend development and scripting" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Unity", level: 70, description: "Game engine development" },
      { name: "C#", level: 75, description: "Game scripting and backend development" },
      { name: "Flutter", level: 65, description: "Mobile app development" },
      { name: "Game Design", level: 70, description: "Interactive experience creation" },
      { name: "AR/VR", level: 60, description: "Immersive technology development" },
    ],
  },
]
